...
package libreria_full.persistencia;
...
import libreria_full.entidades.Editorial;
import libreria_full.persistencia.exceptions.NonexistentEntityException;
...
public class EditorialJpaController implements Serializable {
    ...
    public EditorialJpaController() {
        emf=Persistence.createEntityManagerFactory("Libreria_FullPU");
    }
