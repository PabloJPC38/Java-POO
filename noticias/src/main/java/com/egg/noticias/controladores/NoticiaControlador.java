...
public class NoticiaControlador {
    ...
    @PostMapping("/creando")
    public String creando(@RequestParam String titulo, @RequestParam String cuerpo, @RequestParam("archivo") MultipartFile archivo, ModelMap modelo){
...
//        String nombrefoto = Calendar.getInstance().getTimeInMillis() + extension;
        ...
        try {
            archivo.transferTo(new File("C:/Users/nicoc/Documents/NetBeansProjects/noticias/src/main/resources/static/fotos/" + nombreArchivo));
            noticiaServicio.crearNoticia(titulo, cuerpo, nombreArchivo);
